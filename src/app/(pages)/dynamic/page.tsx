...
const dynamicPage = async () => {
  //! To know in which component we are
  const componentTypes = typeof window === "undefined" ? "Server Component" : "Client Component";
  console.log("Component Type:::", componentTypes);
  ...
  return (
    <div>
      <p>
        <strong>Server Side Rendering</strong>. This is page is <strong>Dynamically</strong> generate on the <strong>Server</strong> ans save to the browser, every time we navigate or refresh the page.{" "}
      </p>
      <hr />
